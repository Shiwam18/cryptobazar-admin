...
!function($) {
    ...
    //creates plot graph
    createPlotGraph(selector, data1, data2, labels, colors, borderColor, bgColor) {
      //shows tooltip
    ...
    //end plot graph
    //creates Pie Chart
    createPieGraph(selector, labels, datas, colors) {
      var data = [{
        label: labels[0],
        data: datas[0]
      }, {
    ...
    createRealTimeGraph(selector, data, colors) {
    ...
    //creates Pie Chart
    createDonutGraph(selector, labels, datas, colors) {
      var data = [{
        label: labels[0],
        data: datas[0]
      }, {

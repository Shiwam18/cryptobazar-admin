(function ($, moment)
{
   ...
   class Plugin {
      ...
      isAfterMinDate(date, checkHour, checkMinute) {
         var _return = true;
      ...
      isBeforeMaxDate(date, checkTime, checkMinute) {
         var _return = true;
      ...
      constructHTMLCalendar(date, calendar) {
         var _template = "";
      ...
      _onYearRangeBeforeClick() {
         this.midYear -= 7;
         this.refreshYearItems();
      }
      _onYearRangeAfterClick() {
         this.midYear += 7;
         this.refreshYearItems();
      }
      _onYearItemClick(e) {
